...
npx snarkjs zkey export solidityverifier artifacts/circuits/proofOfInnocence.zkey artifacts/circuits/Verifier.sol
sed -i.bak "s/contract Verifier/contract Verifier/g" artifacts/circuits/Verifier.sol
